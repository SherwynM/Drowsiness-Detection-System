...
while(True):
    ...
    cv2.rectangle(frame, (0,height-50) , (450,height) , (0,0,0) , thickness=cv2.FILLED )# black rectangle
...
#    for (x, y, w, h) in left_eye:
    ...
    if(score<0):
        score=0
    cv2.putText(frame,'Blink Duration Number:'+str(score),(100,height-20), font, 1,(255,255,255),1,cv2.LINE_AA)
    if(score>15):
